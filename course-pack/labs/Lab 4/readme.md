...
Run your current capstone idea through the 20-Pillar Design System (see prompt below)
Select 5-8 relevant design pillars for your project
For each pillar, generate 10 specific implementation tasks
Prioritize which features are MVP vs. future enhancements
Document your full roadmap with implementation timeline
...
WeekActivityMetricTarget4Baseline measurementInitial accuracyDocument current state6Golden set creationTest coverage50+ test cases7User testing round 1Task completion>70% success rate11Safety auditRed team pass rate>90% blocked14User testing round 2Satisfaction>4.0/5.015Final evaluationAll metricsHit all targets
...
For Each Issue:
markdown### Issue #15: Implement RAG with FAISS Vector Store
...
Paste the 20-Pillar Design System prompt (see AI Prompts Guide)
Input your refined capstone idea:
...
AI generates 20 strategic design pillars like:
...
Select 5-8 pillars most relevant to your project
...
For each selected pillar, AI generates 10 implementation tasks
...
Select which tasks are MVP vs. future roadmap
AI generates final blueprint organizing all selected features
...
Paste the Feature Prioritization prompt (see guide)
...
AI recommends 10 high-impact features across categories:
...
Which AI-generated features resonate most with your vision?
Which features are essential for MVP (Week 15 demo)?
Which features address your biggest technical risks?
Which features are most feasible given your skill set?
...
Example for Receipt Scanner App:
Typical Cases:
...
Define success criteria for each case:
...
Document in your evaluation plan
...
What feedback from today needs to be incorporated?
What are your blockers?
When will you meet to finalize everything?

Instructor available for quick check-ins.

🤖 AI Framework Prompts
All AI prompts are provided in the AI Design Framework Prompts Guide:
Available Frameworks:

20-Pillar Design System
...
Paste into your preferred AI assistant (Claude, ChatGPT, etc.)
Provide your project context
Iterate on AI suggestions
Document final decisions in your deliverables
...
ComponentPointsCriteriaRefined Proposal1.0Updated with Week 3-4 learnings, specific improvements documented, realistic scopeFeature Roadmap (AI-Generated)1.0Used AI frameworks systematically, prioritized features clearly, MVP definedArchitecture Diagram v21.0Complete, accurate, shows evolution from Week 2, all components documentedEvaluation Plan1.0Concrete metrics, golden set defined, user testing protocol clear, timeline realisticCost Model0.5Based on real data, optimizations identified, budget allocatedPresentation Quality0.5Clear communication, defends design decisions, incorporates feedback professionally
Bonus (up to +0.5):
